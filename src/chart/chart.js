    ...
    this.legendItems.forEach((t, e) => {
      ...
      (e = e),
        ...
        isNaN(M) ||
          ...
          v.usePointStyle
            ? ((o = {
              ...
              (l = b.xPlus(e, M / 2)),
              (d = h + S),
              drawPointLegend(f, o, l, d, v.pointStyleWidth && M))
            : ((o = h + Math.max((k - P) / 2, 0)),
              (l = b.leftForLtr(e, M)),
              (d = toTRBLCorners(c.borderRadius)),
              f.beginPath(),
              Object.values(d).some((t) => 0 !== t)
                ? addRoundedRectPath(f, { x: l, y: o, w: M, h: P, radius: d })
                : f.rect(l, o, M, P),
              f.fill(),
              0 !== r && f.stroke()),
          f.restore()),
        ...
        C
          ...
          ? ((d = _.lineHeight), (D.y += calculateLegendItemHeight(t, d)))
          : (D.y += O);
    }),
